package com.yhh.practice.springboot.magic.test4;

import com.yhh.practice.springboot.dao.pachong.DmzjanimationMapper;
...
public class DmzjAnimationProcessor implements PageProcessor {
    @Autowired
     private DmzjanimationMapper dmzjanimationMapper;
    int myid = 0;
    int size =10;
    ...
    public void process(Page page) {
        ...
        dmzjanimationMapper.insert(dmzjAnimation);
    ...
    public static void main(String[] args) {
        ...
        Spider.create(my).addUrl("https://www.dmzj.com/info/benghuai3rd.html").thread(5).run();
