package com.yhh.practice.springboot.magic.test5;

import java.util.List;

import com.yhh.practice.springboot.dao.csdnblog.CsdnblogMapper;
...
public class CsdnBlogPageProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (!page.getUrl().regex("http://blog\\.csdn\\.net/" + username + "/article/details/\\d+").match()) {
            ...
            // 把对象存入数据库
            //new CsdnblogMapper().add(csdnBlog);
            // 把对象输出控制台
    ...
    public static void main(String[] args) {
        ...
        Spider.create(new CsdnBlogPageProcessor()).addUrl("https://blog.csdn.net/qq598535550/article/details/80889843").thread(5).run();
